...
def render() -> UI:
    with UI().padding(px(20)).child_gap(3).top_to_bottom().sizing_fixed(pg.display.get_surface().get_width(), pg.display.get_surface().get_height()).background(Color(255, 255, 255)) as root_element:
